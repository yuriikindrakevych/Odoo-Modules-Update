...
class ins_account_financial_report(models.Model):
    ...
    # Odoo 18: account.account.type model no longer exists, account_type is now a selection on account.account
    account_type_ids = fields.Char('Account Types', help='Comma-separated account type codes (e.g., income,expense)')
