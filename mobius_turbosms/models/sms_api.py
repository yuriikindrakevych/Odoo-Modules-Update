...
# Odoo 18: SMS API structure changed, try multiple import paths
OriginalSmsApi = None
try:
    from odoo.addons.sms.models.sms_api import SmsApi as OriginalSmsApi
except ImportError:
    try:
        from odoo.addons.sms.models.sms_sms import SmsSms as OriginalSmsApi
    except ImportError:
        _logger.warning("TurboSMS: Could not import SmsApi, SMS integration disabled")
